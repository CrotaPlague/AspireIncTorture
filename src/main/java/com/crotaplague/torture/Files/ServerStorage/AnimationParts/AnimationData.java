...
public class AnimationData {
    ...
    public AnimationData(Torture plugin){
        this.plugin = plugin;
        saveDefaultConfig();
    }
    ...
    public void reloadConfig(){
        if(this.configFile == null){
            this.configFile = new File(Torture.path, "AnimationData.yml");
        }
    ...
    public void saveDefaultConfig(){
        if(this.configFile == null) this.configFile = new File(Torture.path, "AnimationData.yml");
